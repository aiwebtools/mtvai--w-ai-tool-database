...
export const appraisalAndValuationGPTs: Tool[] = [
  {
    ...
    tags: ["artwork appraisal", "vintage items", "antiques", "collectibles", "art valuation", "market data", "aiwebtools", "Custom GPT"],
  ...
  },
  {
    ...
    tags: ["antique appraisal", "collectibles", "valuations", "rarity assessment", "market value", "aiwebtools", "Custom GPT"],
    category: "Appraisal & Valuation",
    rating: 4.6,
    totalVotes: 4123
  },
  {
    ...
    tags: ["material valuation", "asset valuation", "precious metals", "market analysis", "wealth management", "aiwebtools", "Custom GPT"],
    category: "Appraisal & Valuation",
    rating: 4.8,
    totalVotes: 5432
  },
  {
    ...
    imageUrl: "https://img1.wsimg.com/isteam/ip/9fd6d942-5b46-4025-92e2-0f1ec2a7adf2/an-advertisement-for-an-antique-and-collectibl.png/:/cr=t:0%25,l:0%25,w:100%25,h:100%25/rs=w:1200,cg:true",
    tags: ["sports cards", "trading cards", "card appraisal", "collectibles", "market value", "grading", "baseball cards", "basketball cards", "football cards", "aiwebtools", "Custom GPT"],
    category: "Appraisal & Valuation",
    rating: 4.7,
    totalVotes: 2891
  }
